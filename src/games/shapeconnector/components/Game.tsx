...
import { IGame, INode } from '../core/types';
import { GameDifficulty, NodeState, UI_COLORS } from '../core/constants';
import * as gameUtils from '../core/utils';
...
export function Game(props: GameProps) {
  ...
  const settings = useMemo(() => {
    return gameUtils.getGameSettings(props.difficulty);
  }, [props.difficulty]);

  const [game, setGame] = useState<IGame>(() => gameUtils.generateGame(settings.boardSize, settings.pathSize));
  ...
  function handleReset() {
    setPath([]);
    setGame(gameUtils.generateGame(settings.boardSize, settings.pathSize));
  }
