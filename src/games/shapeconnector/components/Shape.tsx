...
import { NodeState, SHAPE_COLORS, ShapeColor, ShapeType, UI_COLORS } from '../core/constants';
...
export function Shape(props: ShapeProps) {
  ...
  const fillOpacity = useMemo(() => {
    switch (props.state) {
      ...
      case NodeState.Connected: return 0.4;
  ...
  const strokeOpacity = useMemo(() => {
    switch (props.state) {
      ...
      case NodeState.Connected: return 0.6;
      case NodeState.Selected: return 1;
    }
  }, [props.state]);
